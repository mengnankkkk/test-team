...
import com.mengnnakk.entry.enums.ExamPaperAnswerStatusEnum;
...
import com.mengnnakk.viewmodel.student.exam.ExamPaperReadVM;
...
public class ExamPaperAnswerController extends BaseApiController {
    ...
    public RestResponse edit(@RequestBody @Valid ExamPaperSubmitVM examPaperSubmitVM){
        boolean noutJudge  = examPaperSubmitVM.getAnswerItems().stream().anyMatch(i->i.getDoRight()==null&&i.getScore()==null);
        if (noutJudge){
